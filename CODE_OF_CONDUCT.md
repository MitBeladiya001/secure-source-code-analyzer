...
We pledge to act and interact in ways that contribute to an open, welcoming, diverse, inclusive, and healthy community for the **Secure Source Code Analyzer** project.
...
This Code of Conduct applies to all community spaces, including GitHub repositories, issue trackers, discussion forums, and public channels where individuals represent this project or community. This also applies when an individual is officially representing the project in public spaces, such as when using an official email address, social media account, or acting as an appointed representative at an event.

## Enforcement

Instances of abusive, harassing, or otherwise unacceptable behavior may be reported to the community leaders responsible for enforcement at **brianward.tech@outlook.com**. All complaints will be reviewed and investigated promptly and fairly.
